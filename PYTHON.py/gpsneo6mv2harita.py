...
SerialObj_kontrol = serial.Serial('COM5')
SerialObj_kontrol.baudrate = 115200  # set Baud rate to 115200
...
SerialObj_kontrol.open()  # Seri port bağlantısını aç
...
def update_map():
    try:
        ...
        if (longitude != last_longitude or latitude != last_latitude):
